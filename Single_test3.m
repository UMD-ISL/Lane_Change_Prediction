function Single_test3(Inroot,Outroot_origin,NumberofPoints_on_event,TotalLaneChange,hiddenNodes,learnRates,FeatureFilter,NumberLCTest)
...
%             refertest=1-Targetground;
%             testingTarget=[Targetground;refertest];
% 			save('lane_change.mat','testingInput','Targetground','trainingInput')
