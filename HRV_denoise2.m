function [y2,t2] = HRV_denoise2(t,y,outliers, method, opt1, opt2)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    switch lower(method)
        ...
        case {'spline','cubic','linear'} %Cubic spline replacment            
            no_outliers=1-outliers;
            no_outliers=logical(no_outliers);
            t2=t; 
            if (size(t(no_outliers))==size(t2))
                y2=y;
                return
            end
            y2=interp1(t(no_outliers,:),y(no_outliers,:),t2,'linear');
