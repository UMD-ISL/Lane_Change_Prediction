function [nn] = NNBuilder(trainingInput, trainingTarget, testingInput, testingTarget, netConfig)
    nn.trainNN=@trainNN;                                
%     rand('seed',77);
    %try 10 times and choose NN with best performance;
    minResult=Inf;
    for i=1:20
        ...
        testingErrorAll = (OutputflagTs-testingTarget(1,:));                    %testing output 1?0?
